...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx5ea8df4bbdbb0909',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '2478c0ac745f030cf030057c326f577b',
  ...
  USERS: [
    {
      ...
      id: 'oRAO86YRtYEJ6yO7I9ffikyupwlM',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '6ZDfDZGYNGBrttMPgL91wRi3bAY0yXQx9MjfLfo0bG4',
      // 所在省份
      province: '贵州',
      // 所在城市
      city: '贵阳',
